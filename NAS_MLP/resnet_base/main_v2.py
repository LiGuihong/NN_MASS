...
parser.add_argument('--epochs', type=int, default=60, help='Number of epoch to train')
...
print(density,file=file_logs)
print(net_arch,file=file_logs)
print(net_depth,file=file_logs)
print(nn_mass,file=file_logs)
print(num_seg,file=file_logs)
print(short_cut,file=file_logs)
print(shortcut_tc,file=file_logs)
print(shortcut_num,file=file_logs)
print((100 * float(correct) / total),file=file_logs)
