...
import datetime
#-------------------------------------
file_logs=open('logs_3_v1.txt','a+')
train_logs=open('train_3_v1.txt','a+')
# argument parser
...
def make_dataset(train_file='train.csv',test_file='test.csv'):
    ...
    train_label=np.loadtxt(open("train_label.csv","rb"), delimiter=",")
    train_label=np.array(train_label,dtype=int)

    test_label=np.loadtxt(open("test_label.csv","rb"), delimiter=",")
