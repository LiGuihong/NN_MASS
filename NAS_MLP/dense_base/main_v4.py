...
import datetime
#-------------------------------------
file_logs=open('logs4_v1.txt','a+')
train_logs=open('train4_v1.txt','a+')
features_logs=open('feat_v1.txt','a+')
# argument parser
...
def data_generation():
    ...
    np.savetxt("train_v1.csv", np.array(train_data), delimiter=',')
    np.savetxt("test_v1.csv", np.array(test_data), delimiter=',')
#data_generation()
