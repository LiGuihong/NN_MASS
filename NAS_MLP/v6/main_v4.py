...
import datetime
#-------------------------------------
file_logs=open('logs4_v3.txt','a+')
train_logs=open('train4_v3.txt','a+')
# argument parser
...
#SimpleNet:relu_no_order_no_batch
...
class Simple_batch_order(torch.nn.Module):
    def __init__(self):
        super(Simple_batch_order, self).__init__()
        batchnorm_list=[]
        layer_list=[]
        layer_list.append(nn.Linear(2, net_arch[0]+layer_cut[0]))
...
class SimpleNet_no_relu_no_batch(torch.nn.Module):
    def __init__(self):
        super(SimpleNet_no_relu_no_batch, self).__init__()
        batchnorm_list=[]
        layer_list=[]
        layer_list.append(nn.Linear(2, net_arch[0]+layer_cut[0]))
        batchnorm_list.append(nn.BatchNorm1d(net_arch[0]+layer_cut[0]))
