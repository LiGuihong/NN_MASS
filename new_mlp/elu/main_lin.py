...
#-------------------------------------
file_logs=open('logs/log_noise_v1.txt','a+')
train_logs=open('logs/train_noise_v1.txt','a+')
# argument parser
...
net_arch=[8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8,8]
for i in range(len(net_arch)):
    net_arch[i]=net_width

net_name=['fc0','fc1','fc2','fc3','fc4','fc5','fc6','fc7','fc8','fc9','fc10','fc11','fc12','fc13','fc14','fc15','fc16','fc17','fc18','fc19','fc20','fc21','fc22','fc23','fc24','fc25','fc26','fc27','fc28','fc29','fc30','fc31','fc32','fc33','fc34','fc35','fc36','fc37','fc38','fc39']
all_short_cut=[] 
...
def make_dataset(train_file='data/train_noise.csv',test_file='data/test_noise.csv'):
