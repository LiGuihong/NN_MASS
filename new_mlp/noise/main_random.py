...
#-------------------------------------
file_logs=open('logs/log_rand_v0.txt','a+')
train_logs=open('logs/train_rand_v0.txt','a+')
# argument parser
...
def make_dataset(train_file='data/train_random.csv',test_file='data/test_random.csv'):
