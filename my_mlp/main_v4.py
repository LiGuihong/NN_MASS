...
#-------------------------------------
file_logs=open('logs4_v6.txt','a+')
train_logs=open('train4_v6.txt','a+')
# argument parser
...
[train_data_raw,test_data,train_label_raw,test_label]=make_dataset(train_file='train_circle.csv',test_file='test_circle.csv')
